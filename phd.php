                        ...
                        <div class="card">
                            ...
                            <div class="tab-content card-body">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input id="othernames" type="text" placeholder="Other Name"
                                                                value="" class="form-control" data-skip="true">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div role="group" class="input-group input-group-merge">
                                                                <select id="custom-select" name="physicallyChallenged"
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input id="specify" type="text" placeholder="paralyzed"
                                                                value="" class="form-control"
                                                                data-depends="physicallyChallenged" data-trigger="1">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="media-body">
                                                                    <div class="custom-input" style="width: auto;">
                                                                        ...
                                                                        <input type="file" id="medReport"
                                                                            ...
                                                                            data-depends="physicallyChallenged"
                                                                            data-trigger="1">
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="tab-pane validator" id="second">
                                                        ...
                                                        <div class="form-group m-0" role="group"
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <select id="custom-select"
                                                                        class="form-control custom-select">
                                                                        <option selected>University of cape coast
                                                                        </option>
                                    ...
                                    <div class="form-group row">
                                        <label for="statement" class="col-sm-3 col-form-label form-label">Current
                                            Statement
                                            of
                                            results</label>
                                        <div class="col-sm-9">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <div class="custom-file" style="width: auto;">
                                                        ...
                                                        <label for="statement" class="custom-file-label">Choose
                                                            file</label>
                                                    </div>
                                ...
                                <div class="tab-pane validator" id="third">
                                            ...
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <div class="custom-file" style="width: auto;">
                                                        ...
                                                        <label for="addLetter" class="custom-file-label">Choose
                                                            file</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row my-4">
                                        <label for="recommLetter"
                                            class="col-sm-3 col-form-label form-label">Recommendation
                                            Letters</label>
                                        <div class="col-sm-9">
                                            <div class="media align-items-center">
                                                <!-- <div class="media-left">
                                            ...
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <div class="custom-file" style="width: auto;">
                                                        ...
                                                        <label for="acaCert" class="custom-file-label">Choose
                                                            file</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <div class="custom-file" style="width: auto;">
                                                        ...
                                                        <label for="nssCert" class="custom-file-label">Choose
                                                            file</label>
                                                    </div>
                                                </div>
                                            </div>
